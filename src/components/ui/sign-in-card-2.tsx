          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  ยินดีต้อนรับสู่ Meditation-Khoun
                </motion.h1>
                ...
                >
                  เข้าสู่ระบบเพื่อซิงก์ข้อมูลสถิติและการบันทึกสมาธิ
                </motion.p>
              </div>
              ...
              <form onSubmit={(e) => { e.preventDefault(); setIsLoading(true); setTimeout(() => setIsLoading(false), 2000); }} className="space-y-4">
                <motion.div className="space-y-3">
                  <motion.div className={`relative ${focusedInput === "email" ? 'z-10' : ''}`}>
                    <div className="relative flex items-center overflow-hidden rounded-lg">
                      ...
                      <Input
                        type="email"
                        placeholder="Email address (เช่น name@example.com)"
                        value={email}
                  ...
                  <motion.div className={`relative ${focusedInput === "password" ? 'z-10' : ''}`}>
                    <div className="relative flex items-center overflow-hidden rounded-lg">
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="h-4 w-4 rounded border border-white/20 bg-white/5 checked:bg-white"
                    />
                    <label htmlFor="remember-me" className="text-xs text-white/60 hover:text-white/80">
                      จำฉันไว้ในระบบ
                    </label>
                  </div>
                  <a href="#" className="text-xs text-white/60 hover:text-white">ลืมรหัสผ่าน?</a>
                </div>
